...
public class QSchemaVersion extends com.mysema.query.sql.RelationalPathBase<QSchemaVersion> {
    ...
    private static final long serialVersionUID = 213326458;
    ...
    public QSchemaVersion(String variable) {
        super(QSchemaVersion.class, forVariable(variable), "shibainu", "schema_version");
    }

    @SuppressWarnings("all")
    public QSchemaVersion(Path<? extends QSchemaVersion> path) {
        super((Class)path.getType(), path.getMetadata(), "shibainu", "schema_version");
    }

    public QSchemaVersion(PathMetadata<?> metadata) {
        super(QSchemaVersion.class, metadata, "shibainu", "schema_version");
    }
